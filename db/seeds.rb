...
model = ['Vélo B-Twin', 'Vélo piste Motobécane', 'Canyon spectral', 'Fixie Lejeune', 'Vélo de ville femme', 'VTT homme Btwin', 'VTT femme Go Sport', 'Vélo de ville femme Gitane', 'Vélo hollandais Peugeot', 'Randonneuse Helium', 'Vélo de ville Raymond Poulidor', 'Vélo Hangler']
...
image_urls.sample(100).each do |url|
  file = URI.open(url)
  bike = Bike.create!(
    model: model.sample,
